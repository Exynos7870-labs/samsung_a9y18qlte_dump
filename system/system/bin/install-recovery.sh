#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/bootdevice/by-name/recovery:27337232:f7d5b96b5f3692360b42ea33c7a5a54996446989; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/bootdevice/by-name/boot:18575888:1bf5d2ba6be895018c8fdf5ae3f5df3b8bc82a76 \
          --target EMMC:/dev/block/bootdevice/by-name/recovery:27337232:f7d5b96b5f3692360b42ea33c7a5a54996446989 && \
